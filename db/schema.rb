...
ActiveRecord::Schema.define do
  ...
  create_table "actionals", :force => true do |t|
  ...
  add_index "actionals", ["user_id"], :name => "index_actionals_on_user_id"
  add_index "actionals", ["tag_id"], :name => "index_actionals_on_tag_id"
  ...
  create_table "comments", :force => true do |t|
    ...
    t.text     "content"
    t.integer  "commentable_id",          :default => 1
