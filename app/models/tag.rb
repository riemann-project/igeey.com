class Tag < ::ActiveRecord::Base
  ...
  def self.find_or_create_with_like_by_name(name) # NOTICE: not unused methods
  ...
  class << self
    ...
    # def counts(options = {}) # unused methods
    #   find(:all, options_for_counts(options))
    # end

    # def options_for_counts(options = {}) # unused methods
